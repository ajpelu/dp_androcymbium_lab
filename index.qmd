...
individuals in 50 cm x 50 cm fix squares, taking four squares per plot, distributed according
...
The evaluation of plant communities where *A. europaeum* lives was conducted annually during the spring season to ensure that most annual species had grown and flowered, allowing for accurate identification. In each plot, two fixed cross transects measuring 2 meters in length were established (@fig-sampling). The point-intercept method [@Elzingaetal2001MonitoringPlant] was employed, with 50 points surveyed per transect. These points were spaced 4 cm apart, and the plant species in contact with a 2 mm needle were recorded. For each transect the following variables were determined:
